...
The description of the algorithm to find interpolant from proofs is based on {% cite McM03 --file citations-itp %}. A proof of unsatisfiability $$\Pi$$ for a set of clauses $$C$$ is a directed acyclic graph $$(V, E)$$, where $$V$$ is a set of clauses, and
